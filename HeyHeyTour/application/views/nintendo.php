...
<html>
    <head>
		...
		<script>window.jQuery || document.write('<script src="/~team13/my/js/jquery-1.11.2.min.js"><\/script>')</script>
		<script src="/~team13/my/js/popper.min.js"></script>		
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js" type="text/javascript"></script>
		<script src="/~team13/my/js/jquery-3.3.1.min.js"></script>
        ...
        <link rel="stylesheet" href="/~team13/my/css/test.css">	
...
<body>
        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
			...
			<input id="nav2" class="search" type="text" placeholder="검색창"></input>
			...
			<!-- 로그인처리 -->
				...
				if(!$name)
				{
					echo("<font color='white'>로그인 요망</font><br>
					<li>
				...
				{
					echo("<font color='white'>환영합니다 $name 님</font><br>
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									  ...
									  <div class="modal-header" style="background-color: #45489a;">
										<h5 class="modal-title" id="exampleModalLabel"><font color="#fff">로그인</font></h5>
            ...
            <section id="featured" class="content-section">
                ...
                <div class="section-content">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="image">
                                <img src="/~team13/my/img/featured_1.jpg" alt="">
                        ...
                        <div class="item">
                            <div class="image">
                                <img src="/~team13/my/img/featured_2.jpg" alt="">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="image">
                                <img src="/~team13/my/img/featured_3.jpg" alt="">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                    ...
                    <div class="masonry">
                        <div class="row">
                            <div class="item ">
                                ...
                                <div class="col-md-8">
                                    <a href="/~team13/my/img/portfolio_big_1.jpg" data-lightbox="image"><img src="/~team13/my/img/portfolio_1.jpg" alt="image 1"></a>
									<div class="overlay">
										ASIA
									</div>
                                </div>
                            ...
                            <div class="item second-item">
                                <div class="col-md-4">
                                    <a href="/~team13/my/img/portfolio_big_2.jpg" data-lightbox="image"><img src="/~team13/my/img/portfolio_2.jpg" alt="image 2"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="/~team13/my/img/portfolio_big_3.jpg" data-lightbox="image"><img src="/~team13/my/img/portfolio_3.jpg" alt="image 3"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="/~team13/my/img/portfolio_big_4.jpg" data-lightbox="image"><img src="/~team13/my/img/portfolio_4.jpg" alt="image 4"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="/~team13/my/img/portfolio_big_5.jpg" data-lightbox="image"><img src="/~team13/my/img/portfolio_5.jpg" alt="image 5"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <section id="first-tab-group" class="tabgroup">
                                <div id="tab1">
                                    <ul>
                                        <li>
                                            <div class="item">
                                                <img src="/~team13/my/img/blog_1.jpg" alt="">
                                                <div class="text-content">
                                        ...
                                        <li>
                                            <div class="item">
                                                <img src="/~team13/my/img/blog_2.jpg" alt="">
                                                <div class="text-content">
                                        ...
                                        <li>
                                            <div class="item">
                                                <img src="/~team13/my/img/blog_3.jpg" alt="">
                                                <div class="text-content">
                                                    <h4>Sed at massa turpis</h4>
