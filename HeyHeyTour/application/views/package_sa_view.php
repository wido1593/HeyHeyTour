<?
	...
	$tmp = $text1 ? "/no/$no/text1/$text1/page/$page" : "/no/$row->package_sa_no/page/$page";
/*	echo($row->name9);
	echo("<br>");
	echo($row->name9);
	echo("<br>");
...
<div role="alert"><h5><b>가게 정보</b></h5></div>
	...
	<table class="table table-bordered table-sm mymargin5">
		...
		<tr> 
		    ...
		    <td width="80%" align="left"><div class="form-inline"><?=$row->package_sa_no;?></div></td>
		</tr>
<!---이름---->
<tr>
...
<tr>
    ...
    <td width="80%" align="left">
        <div class="form-inline"><div class="form-inline"><?=$row->southamerica_name;?></div>
    </td>
</tr>
...
<div align="center">
<a href="/~team13/package_sa/edit<?=$tmp;?>" class="btn btn-sm mycolor3">수정</a>
<a href="/~team13/package_sa/del<?=$tmp; ?>" class="btn btn-sm mycolor3" onClick="return confirm('삭제할까요?');">삭제</a>&nbsp
