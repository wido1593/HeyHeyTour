...
<tr>
	    ...
	    <td width="80%" align="left">
		    <div class="form-inline">
				 <input  type="text" name="no" size = "20" maxlength = "20"  value="<?=$row->package_asia_no?>" class="form-control from-control-sm" >
			</div>
	    </td>
	</tr>
...
<tr>
	    ...
	    <td width="80%" align="left">
		    <div class="form-inline">	
				<textarea style="width:500px; height:200px;" rows="4" cols="50" name="bigo" maxlength="255"><?=$row->bigo?></textarea>
			</div>
	    </td>
