        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
			...
			<form name="form1" action="" method="post">		
				...
				<input id="nav2" class="search" type="text" name="serchValue" placeholder="검색창" onkeypress="if(event.keyCode==13){search(); return false;}"></input>
                 ...
                 <ul>
                    <li onclick="location.href='/~team13/asia';">
                        <a href="#top">
                    ...
                    <li onclick="location.href='/~team13/europe';">
                        <a href="#featured">
                            <span class="rect"></span>
                            <span class="circle"></span>
                            Europe
                    ...
                    <li onclick="location.href='/~team13/africa';">
                        <a href="#projects">
                            <span class="rect"></span>
                            <span class="circle"></span>
                            Africa
                    ...
                    <li onclick="location.href='/~team13/northamerica';">
                        <a href="#projects">
                            <span class="rect"></span>
                            <span class="circle"></span>
                            North America
                    ...
                    <li onclick="location.href='/~team13/southamerica';">
                        <a href="#projects">
                            <span class="rect"></span>
                            <span class="circle"></span>
                            South America
